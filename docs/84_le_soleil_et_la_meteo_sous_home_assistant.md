...
Pour [utiliser ces prévisions météorologiques dans des automatisations](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-la_meteo_dans_les_automatisations), vous travaillerez avec [l'entité Weather](https://www.home-assistant.io/integrations/weather/).
...
Les [données météo par défaut](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-meteo_par_defaut_dans_home_assistant) de Home Assistant peuvent être utilisées directement sans nécessiter de configuration spécifique.
...
La fiche « [service\_openweathermap](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-service_openweathermap) » donne les instructions pour obtenir la clé API requise (gratuit).
...
* La valeur entrée dans la case Nom, qui contient par défaut la valeur OpenWeatherMap, sera utilisée [dans l'identifiant des entités créées](67_chapitre_de_reference_pour_home_assistant.md#fiche-qu_est-ce_qu_une_entite).
...
Pour [utiliser ces prévisions météorologiques dans des automatisations](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-la_meteo_dans_les_automatisations), vous travaillerez avec l'entité weather.openweathermap ou une de ses sous-entités, par exemple sensor.openweathermap\_temperature comme déclencheur ou comme condition, selon vos besoins.
...
Ces données peuvent provenir [de l'intégration ajoutée automatiquement lors de l'installation de Home Assistant](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-meteo_par_defaut_dans_home_assistant) ou encore d'une autre intégration à votre choix, par exemple [OpenWeatherMap](84_le_soleil_et_la_meteo_sous_home_assistant.md#fiche-travailler_avec_l_integration_openweathermap).
