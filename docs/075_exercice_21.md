...
## 340 — 4.1 Communication Jeedom - Home Assistant via l'API
...
4. À partir d'une commande de type action, effectuez une opération sur un récepteur dans Jeedom à partir de Home Assistant. Par exemple, éteignez une lumière réelle ou virtuelle.
