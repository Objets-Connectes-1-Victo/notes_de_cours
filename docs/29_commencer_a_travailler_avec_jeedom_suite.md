# 26. Commencer à travailler avec Jeedom (suite) {#chapitre-commencer_a_travailler_avec_jeedom_suite}

## 26.1 En résumé... {#fiche-en_resume_042}
...
## <a href="fiche-le\_dashboard\_jeedom.md#le\_dashboard\_jeedom">le\_dashboard\_jeedom</a>
...
## <a href="fiche-ajouter\_un\_appareil\_connecte\_z-wave\_a\_jeedom.md#ajouter\_un\_appareil\_connecte\_z-wave\_a\_jeedom">ajouter\_un\_appareil\_connecte\_z-wave\_a\_jeedom</a>

Bien suivre ces étapes!

## <a href="fiche-configurer\_une\_tuile.md#configurer\_une\_tuile">configurer\_une\_tuile</a>

Vous aurez une petite correction à apporter au code de Jeedom. Voir la fiche « <a href="fiche-le\_noeud\_n\_a\_pas\_encore\_de\_commande.md#le\_noeud\_n\_a\_pas\_encore\_de\_commande">le\_noeud\_n\_a\_pas\_encore\_de\_commande</a> ».
...
## <a href="fiche-travailler\_avec\_la\_meteo\_sous\_jeedom.md#travailler\_avec\_la\_meteo\_sous\_jeedom">travailler\_avec\_la\_meteo\_sous\_jeedom</a>

Bien suivre ces étapes!

## 26.2 Le dashboard Jeedom {#fiche-le_dashboard_jeedom}
...
![Dashboard Jeedom](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Dashboard.png)
...
![Catégorie d'équipement](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-CategorieEquipement.png)
...
## Déplacer et redimensionner les tuiles {#redimensionner}
...
## Pour plus d'information {#deconnecter}
...
Une fois que vous avez <a href="fiche-configurer\_la\_cle\_usb\_z-wave\_sur\_jeedom.md#configurer\_la\_cle\_usb\_z-wave\_sur\_jeedom">ajouté votre clé USB Z-Wave dans Jeedom</a>, vous pouvez y ajouter des appareils connectés.
...
* Si la prise a déjà été pairée à un autre système (ce sera le cas avec le matériel prêté par l'école), vous devez d'abord la réinitialiser (factory reset). Vérifiez le manuel de l'utilisateur pour connaître les opérations à réaliser pour y parvenir. Dans le cas de la prise intelligente Zooz utilisée dans cet exemple, il faut appuyer sur le bouton pendant 20 secondes.
  ...
  ![Extrait du manuel - factory reset](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/ZoozSmartPlug-ExtraitManuelFactoryReset.png)
...
* Choisissez le mode Inclusion par défaut puis cliquez sur Démarrer.
  ...
  ![Inclusions](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Inclusions.png)
...
* Une fois que vous voyez le message indiquant le mode inclusion, vous devez effectuer une opération sur l'objet connecté pour le mettre en mode pairage.
  ...
  ![Extrait du manuel Zooz Smart plug](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/ZoozSmartPlug-ExtraitManuel.png)
...
* Jeedom affichera ensuite l'écran de configuration de l'équipement.
  ...
  + Nom de l'équipement
  + <a href="fiche-objets\_pour\_representer\_la\_maison.md#objets\_pour\_representer\_la\_maison">Objet parent</a>
  + Si désiré : Catégorie
...
![Valeurs récepteur](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ValeursPriseMinoston.png)
...
![Valeurs capteur](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ValeursNeoCoolcam.png)

## 26.4 Le noeud n'a pas encore de commande {#fiche-le_noeud_n_a_pas_encore_de_commande}
...
![Le noeud n'a pas encore de commande](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-LeNoeudNAPasEncoreDeCommande.png)
...
Suivez les étapes données sur la fiche « <a href="fiche-configurer\_une\_tuile.md#configurer\_une\_tuile">configurer\_une\_tuile</a> ».
...
* Les valeurs sont présentées dans différentes sections, par exemple Binary Switch, Notification, etc. Certaines commandes sont de type Info, c'est-à-dire qu'elles permettent d'afficher un état. D'autres sont de type Action, c'est-à-dire qu'elles permettent d'envoyer un ordre à l'équipement, par exemple Allume-toi.
  ...
  ![Créer la commande Action](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-CreerLaCommandeAction.png)
  ...
  Important : si vous voyez un carré rouge sans texte qui apparaît au bas de l'écran, c'est que vous n'avez pas <a href="fiche-le\_noeud\_n\_a\_pas\_encore\_de\_commande.md#le\_noeud\_n\_a\_pas\_encore\_de\_commande">corrigé les erreurs de programmation</a> dans le fichier /var/www/html/plugins/zwavejs/core/class/zwavejs.class.php.
...
* Vous verrez au moins une nouvelle commande pour chaque ajout que vous avez réalisé. Dans cet exemple, une commande de type Info permet de savoir si la prise est allumée ou éteinte. Deux commandes de type Action ont été ajoutées, la première pour éteindre la prise, la seconde pour l'allumer.
  ...
  ![Commandes ajoutées](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-CommandesAjoutees.png)
  ...
  ![Commandes Allumer et Éteindre](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-CommandesAllumerEtEteindreMultilevelSwitch.png)
...
* Pour chaque commande, donnez-lui un nom significatif dans la colonne Nom puis cochez les cases Afficher et, pour les commandes de type Info, Historiser.
  ...
  ![Modifications aux commandes ajoutées](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-CommandesAjoutees-2.png)
* Dans le cas d'un capteur d'ouverture de porte, il arrive que la valeur retournée soit 22 lorsque la porte est ouverte (aimants éloignés) ou 23 lorsque la porte est fermée (aimants collés).
  ...
  ![Configuration de la commande](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ConfigurationCommandeEtatPorte.png)
...
## 26.6 Configurer la page de synthèse {#fiche-configurer_la_page_de_synthese}
...
* Cliquez sur le bouton Résumé(s) et cochez le type de résumé que vous désirez voir apparaître dans la synthèse.
  ...
  ![Type de résumé](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ConfigurerResumeEquipement.png)
...
![Synthèse](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Synthese.png)

## 26.7 Ajouter une prise Wi-Fi Tuya/SmartLife à Jeedom {#fiche-ajouter_une_prise_wi-fi_tuya_smartlife_a_jeedom}
...
![Prise Wi-Fi Teckin](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/PriseIntelligenteWiFi.png)
...
Suivez <a href="fiche-integration\_tuya\_pour\_ajouter\_des\_prises\_wi-fi\_teckin\_dans\_home\_assistant.md#integration\_tuya\_pour\_ajouter\_des\_prises\_wi-fi\_teckin\_dans\_home\_assistant">les étapes détaillées pour le pairage dans l'application SmartLife</a>. Ne suivez que les instructions de la section « Configuration de la prise Wi-Fi sur votre téléphone » car les autres sections ne concernent pas Jeedom.
...
![Plugin SmartLife](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-PluginSmartLife.png)
...
## 26.8 Travailler avec la météo sous Jeedom {#fiche-travailler_avec_la_meteo_sous_jeedom}
...
![Météo](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-PluginWeather.png)

Une fois installé vous devrez l'activer sur sa page de configuration.

![Activer le plugin Météo](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Meteo-Activer.png)
...
![Météo Victoriaville](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Meteo-Victoriaville.png)
...
Pour voir toutes les informations présentées, vous devrez peut-être <a href="fiche-le\_dashboard\_jeedom.md#le\_dashboard\_jeedom">redimensionner la tuile</a> de la météo.
...
![Météo sur le Dashboard](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Dashboard-Meteo.png)

Voici la même tuile mais cette fois, après avoir coché Mode image.

![Mode image](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Dashboard-MeteoModeImage.png)

## 26.9 Exclure un appareil de Jeedom {#fiche-exclure_un_appareil_de_jeedom}
...
* Exclure l'appareil de votre boîte domotique (même s'il n'a jamais été inclus dans cette boîte). Dans Jeedom, rendez-vous dans Plugins / Protocole domotique / Z-Wave JS / Bouton Inclusions. Choisissez Exclusion. Après avoir cliqué sur Démarrer, effectuez l'opération sur l'appareil connecté pour le mettre en mode pairage. Consultez le manuel de l'appareil pour connaître la procédure spécifique à votre appareil. Jeedom confirmera l'exclusion.
  ...
  ![Exclusion](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Exclusion.png)