# 50. Contrôle GPIO avec Jeedom {#chapitre-controle_gpio_avec_jeedom}

## 50.1 En résumé... {#fiche-en_resume_044}
...
![Équipement dans le plugin Script](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-PluginScript-Equipement.png)
...
* Arrêter le scénario qui avait lancé le cligotement  
  ...
  ![Arrêter un scénario](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ScenarioQuiArreteUnAutreScenario.png)
...
## 50.2 Lancer un script Python avec le plugin Script {#fiche-lancer_un_script_python_avec_le_plugin_script}
...
![Plugin Script](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-PluginScript.png)
...
Pour lancer une commande ou une série de commandes qui contrôlent une LED, un [script Python](53_scripts_python_pour_envoyer_et_recevoir_du_signal_sur_le_gpio.md#fiche-la_base_des_scripts_avec_rpi_gpio) est un excellent choix.
...
* l'écrire sur votre ordinateur personnel puis de le [copier sur le Pi](53_scripts_python_pour_envoyer_et_recevoir_du_signal_sur_le_gpio.md#fiche-copier_un_fichier_sur_une_machine_linux_a_partir_d_un_autre_ordinateur) ![Conseil](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Ampoule.svg "scp dossierlocal/monfichier.extension pi@192.168.1.145:/dossier/sous-dossier").
...
Vous devez absolument [changer l'encodage des fins de lignes](04_linux.md#fiche-encodage_des_fins_de_lignes_crlf_vs_lf) afin que Linux puisse utiliser le fichier.
...
Sachez que si le script est placé dans le dossier /var/www/html ou dans un de ses sous-dossiers, il fera automatiquement partie de [la copie de sécurité de Jeedom](18_pour_vous_assurer_de_ne_rien_perdre_en_cas_de_probleme.md#fiche-copie_de_securite_de_jeedom).
...
![Chemin des scripts utilisateur](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-PluginScript-CheminDesScriptsUtilisateur.png)

## Lancement du script à partir de Jeedom {#lancer}
...
Le script, qui est une commande d'un équipement au yeux de Jeedom, peut désormais être utilisé au même titre que n'importe quelle autre commande [dans vos scénarios Jeedom](35_les_scenarios_jeedom.md#fiche-creer_un_scenario_provoque)!
...
## 50.3 Arrêter correctement un scénario avec boucle infinie {#fiche-arreter_correctement_un_scenario_avec_boucle_infinie}
...
Parfois, cependant, la tâche à réaliser nécessite une telle boucle, par exemple [pour faire clignoter une DEL branchée au GPIO,clignoter](53_scripts_python_pour_envoyer_et_recevoir_du_signal_sur_le_gpio.md#fiche-la_base_des_scripts_avec_rpi_gpio).
...
![Scénario boucle sans fin](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ScenarioBoucleSansFinSurDashboard.png)
...
![Sélectionner un mot-clé](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Scenario-SelectionnerUnMotCle-2.png)
...
![scénario qui arrête un autre scénario](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-ScenarioQuiArreteUnAutreScenario.png)
...
![pkill](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Jeedom-Script-pkill.png)
...
* lancer un script Python qui se charge d'éteindre la DEL
  ...
  ou
* lancer le [script Python qui se charge de réinitialiser toutes les broches](53_scripts_python_pour_envoyer_et_recevoir_du_signal_sur_le_gpio.md#fiche-script_pour_reinitialiser_toutes_les_broches_programmables_du_gpio)
...
Un script Python peut [recevoir des paramètres](53_scripts_python_pour_envoyer_et_recevoir_du_signal_sur_le_gpio.md#fiche-passer_un_parametre_a_un_script_python).
