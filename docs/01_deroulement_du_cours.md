...
1 - Analyser le projet de développement de l’application  
 ...
 3 - Générer ou programmer l’interface utilisateur  
 4 - Programmer la logique applicative de l’objet et la logique applicative de contrôle ou de surveillance  
 5 - Contrôler la qualité de l’application  
 6 - Participer à la mise en service de l’application  
...
La compétence 00SX : Effectuer le développement d’applications pour des objets connectés est vue partiellement.
...
À la fin de ce cours, l'élève sera capable d'effectuer le développement d’applications pour des objets connectés.
...
Des activités seront proposées pour favoriser la coopération entre les élèves, l’échange des connaissances et la prise en charge de son apprentissage par l'élève.
...
### 00SX - 1 : Analyser le projet de développement de l’application
...
### 00SX - 2 : Préparer l’environnement de développement informatique et le banc d’essai
...
2. Position et fixation correctes des objets dans l’environnement de simulation
3. Connexion correcte des objets à l’ordinateur de développement, au réseau ou à d’autres objets

### 00SX - 3 : Générer ou programmer l’interface utilisateur
...
1. Choix et utilisation appropriés des éléments graphiques pour l’affichage et la saisie
2. Intégration correcte des images
3. Adaptation de l’interface en fonction du format d’affichage et de la résolution
...
1. Programmation correcte des interactions entre l’interface et l’utilisatrice ou l’utilisateur
...
### 00SX - 5 : Contrôler la qualité de l’application
...
### 00SX - 6 : Participer à la mise en service de l’application
...
2. Pertinence de l’information transmise aux utilisatrices ou utilisateurs sur le fonctionnement et la sécurité de l’application
...
1. Détermination correcte de l’information à rédiger
...
À partir d'une boîte domotique existante, l'élève devra ajouter, configurer et programmer l'interface pour une quantité définie d'objets connectés selon les devis fournis.
...
*5.6 En cas d’erreur lors de la remise d’une évaluation sommative, une récidive, tous cours d’informatique confondus, entraînera la note de 0 pour l’évaluation concernée. Aucun document altéré après la date de remise ne sera accepté.*
