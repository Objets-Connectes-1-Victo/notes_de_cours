...
6. Modifiez une de vos automatisations pour que l'action n'ait lieu que [s'il fait AU MOINS 10 degrés celcius](83_les_automatisations_home_assistant.md#fiche-ajouter_une_automatisation_a_l_aide_de_l_interface_graphique) (ou autre température de votre choix). Assurez-vous que la carte bouton tienne compte des conditions.
