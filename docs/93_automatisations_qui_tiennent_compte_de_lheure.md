...
L'affichage de la date et de l'heure actuelles est réalisé en ajoutant un capteur virtuel de type sensor. Attention : ce capteur est différent des [capteurs virtuels de type input_datetime qui permettent de saisir la date et l'heure](79_les_capteurs_virtuels.md#fiche-configurer_un_capteur_virtuel)!
