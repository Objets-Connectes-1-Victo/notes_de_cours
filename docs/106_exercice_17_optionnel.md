...
3. Copiez la base de données de Home Assistant vers votre ordinateur. Faites une impression d'écran qui montre clairement ce fichier sur votre ordinateur. On doit également voir sa date et sa taille. Nommez ce fichier au format NomPrenom-scp.png.
...
4. Pour chaque entité du système, on retrouve un identifiant en toutes lettres, par exemple sensor.neo\_capteur\_5\_en\_1\_illuminance.
