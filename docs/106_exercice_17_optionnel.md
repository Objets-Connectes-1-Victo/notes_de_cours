# 95. Exercice 17 - OPTIONNEL {#chapitre-exercice_17_optionnel}

## 95.1 Explorer la base de données et les statistiques de Home Assistant {#fiche-explorer_la_base_de_donnees_et_les_statistiques_de_home_assistant}
...
3. <a href="fiche-contenu\_de\_la\_base\_de\_donnees\_de\_home\_assistant.md#contenu\_de\_la\_base\_de\_donnees\_de\_home\_assistant">Copiez la base de données de Home Assistant vers votre ordinateur</a>. Faites une impression d'écran qui montre clairement ce fichier sur votre ordinateur. On doit également voir sa date et sa taille. Nommez ce fichier au format NomPrenom-scp.png.
...
4. Pour chaque entité du système, on retrouve <a href="fiche-qu\_est-ce\_qu\_une\_entite.md#qu\_est-ce\_qu\_une\_entite">un identifiant</a> en toutes lettres, par exemple sensor.neo\_capteur\_5\_en\_1\_illuminance.
