...
3. [Copiez la base de données de Home Assistant vers votre ordinateur,copie](104_la_base_de_donnees_home_assistant.md#fiche-contenu_de_la_base_de_donnees_de_home_assistant). Faites une impression d'écran qui montre clairement ce fichier sur votre ordinateur. On doit également voir sa date et sa taille. Nommez ce fichier au format NomPrenom-scp.png.
