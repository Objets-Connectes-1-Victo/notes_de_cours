# 36. La base de données Jeedom {#chapitre-la_base_de_donnees_jeedom}

## 36.1 En résumé... {#fiche-en_resume_026}
...
## 36.2 Retrouver le mot de passe de la base de données Jeedom {#fiche-retrouver_le_mot_de_passe_de_la_base_de_donnees_jeedom}

Il y a toujours une façon de [réinitialiser le mot de passe](40_la_base_de_donnees_jeedom.md#fiche-reinitialiser_le_mot_de_passe_mysql_de_jeedom) pour accéder à une base de données MySQL, en autant qu'on ait un accès à une fenêtre Terminal sur le serveur MySQL, en l'occurence le Raspberry Pi.
...
## 36.3 Réinitialiser le mot de passe MySQL de Jeedom {#fiche-reinitialiser_le_mot_de_passe_mysql_de_jeedom}

Je vous propose deux manipulations à effecture sur le serveur de base de données MySQL installé sur votre boîte Jeedom :

* [Modification du mot de passe](https://apical.xyz/formations/pageunique/systeme_domotique_diy#modification) alors que le mot de passe actuel est connu
* [Réinitialisation du mot de passe](https://apical.xyz/formations/pageunique/systeme_domotique_diy#reinitialisation) lorsque le mot de passe actuel n'est pas connu

## Modification du mot de passe {#modification}
...
* Connectez-vous au Raspberry Pi soit [via SSH](05_raspberry_pi.md#fiche-se_brancher_au_raspberry_pi_via_ssh) ou encore en y branchant un clavier et un écran.
* Lancez la ligne de commande MySQL puis entrez [le mot de passe actuel](40_la_base_de_donnees_jeedom.md#fiche-retrouver_le_mot_de_passe_de_la_base_de_donnees_jeedom) lorsque demandé.
...
```sql
  exit
```
* Vous devez maintenant [dire à Jeedom quel est le nouveau mot de passe](https://apical.xyz/formations/pageunique/systeme_domotique_diy#configurationjeedom).

## Réinitialisation du mot de passe {#reinitialisation}

Avant de tenter une réinitialisation du mot de passe pour accéder à la base de données MySQL de Jeedom, sachez qu'il est possible de [retrouver ce mot de passe directement dans la console d'administration de Jeedom](40_la_base_de_donnees_jeedom.md#fiche-retrouver_le_mot_de_passe_de_la_base_de_donnees_jeedom).
...
## Dire à Jeedom quel est le nouveau mot de passe {#configurationjeedom}

À ce stade, si vous tentez d'accéder à [l'interface d'administration de Jeedom,acceder](17_jeedom_au_coeur_de_votre_systeme_domotique.md#fiche-installation_de_jeedom_et_premier_acces), vous obtiendrez le message « SQLSTATE[HY000] [1045] Access denied for user 'jeedom'@'localhost' (using password: YES) ». Il faut donc effectuer une manipulation supplémentaire pour que Jeedom utilise le nouveau mot de passe.
...
## 36.4 Contenu de la base de données de Jeedom {#fiche-contenu_de_la_base_de_donnees_de_jeedom}
...
* [Effectuez une copie de sécurité de Jeedom](18_pour_vous_assurer_de_ne_rien_perdre_en_cas_de_probleme.md#fiche-copie_de_securite_de_jeedom).
