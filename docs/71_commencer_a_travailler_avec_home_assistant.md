...
Vous pouvez maintenant [intégrer des appareils connectés Z-Wave à Home Assistant](71_commencer_a_travailler_avec_home_assistant.md#fiche-ajouter_un_appareil_connecte_z-wave_a_home_assistant).
