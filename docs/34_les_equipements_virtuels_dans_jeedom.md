...
Note : si le plugin n'est pas disponible, c'est peut-être parce que vous devez [mettre à jour votre système](33_messages_et_mises_a_jour.md#fiche-le_centre_de_mise_a_jour_de_jeedom).
