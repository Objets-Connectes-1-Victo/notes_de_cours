...
1. Prenez soin de [valider vos configurations](77_le_fichier_configurationyaml.md#fiche-validation_des_configurations) avant de [les recharger](77_le_fichier_configurationyaml.md#fiche-Editer_le_fichier_configuration_yaml) (inutile de redémarrer le système au complet).
