...
Dans le cas où Home Assistant est encore fonctionnel, vous pouvez procéder directement à l'[étape de restauration](#restauration).

S'il ne fonctionne plus du tout, vous devrez d'abord effectuer une [réinstallation](#reinstallation).
...
* Poursuivez avec [les étapes communes pour la réinstallation et la restauration](#commune).
