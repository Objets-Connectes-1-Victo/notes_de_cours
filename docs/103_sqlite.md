...
Pour travailler avec une base de données [SQLite](103_sqlite.md#fiche-Qu_est-ce_que_SQLite), il n'y a aucun serveur à installer. Tout se déroule localement.
...
Pour lancer la ligne de commande SQLite sous Windows, vous devez d'abord [installer SQLite sur votre poste de travail et faire en sorte que son dossier fasse partie du PATH](103_sqlite.md#fiche-Installation_de_SQLite)).
