...
1. Faites le nécessaire pour pouvoir [envoyer du courriel avec Home Assistant](94_notification_par_courriel.md#fiche-configurer_home_assistant_pour_l_envoi_de_courriel).
...
4. Créez une automatisation qui [retrouve l'adresse IP du Raspberry Pi à l'aide d'un modèle](67_chapitre_de_reference_pour_home_assistant.md#fiche-trouver_l_adresse_ip_de_home_assistant) et qui vous l'envoie par courriel lors du démarrage de Home Assistant.
5. Créez une automatisation qui ajoute une entrée dans le journal des activités [à 10h tous les jours](93_automatisations_qui_tiennent_compte_de_lheure.md#fiche-automatisation_qui_tient_compte_de_l_heure) (vous pouvez changer l'heure pour vos tests).
