...
* [des capteurs virtuels](79_les_capteurs_virtuels.md#fiche-configurer_un_capteur_virtuel) que vous pourrez ajuster dans l'onglet Aperçu
* des capteurs réels
...
Si, lorsque vous testez un tel modèle dans l'éditeur, vous obtenez un message du genre « TemplateSyntaxError: expected token 'end of print statement', got '... », c'est peut-être parce que l'identifiant de l'objet (ce qui suit le point dans l'[identifiant de l'entité](67_chapitre_de_reference_pour_home_assistant.md#fiche-qu_est-ce_qu_une_entite)) débute par un caractère non autorisé, par exemple un chiffre.
...
Il est suggéré de tester ce modèle dans [l'éditeur de modèle,editeur](89_les_modeles_home_assistant.md#fiche-les_modeles_dans_home_assistant) avant de l'utiliser dans une automatisation.
...
* Toutes les informations [encodées en JSON](127_format_json_dans_un_modele.md#fiche-format_json_dans_un_modele)
...
Pour connaître [l'identifiant de l'entité,identifiant](67_chapitre_de_reference_pour_home_assistant.md#fiche-qu_est-ce_qu_une_entite), cliquez sur une entité puis cliquez sur l'icône d'engrenage.
...
En plus de permettre de [retrouver la valeur d'une entité](89_les_modeles_home_assistant.md#fiche-retrouver_les_valeurs_d_une_entite), les modèles permettent d'effectuer une foule de manipulations sur ces informations.
...
Sous Home Assistant, les opérations d'addition et de soustractions sur les dates et heures peuvent être effectuées à l'aide d'un [modèle](89_les_modeles_home_assistant.md#fiche-les_modeles_dans_home_assistant).
...
Quand vient le temps de [personnaliser le tableau de bord de Home Assistant](80_les_tableaux_de_bord.md#fiche-creer_un_tableau_de_bord_personnalise), les cartes Markdown offrent beaucoup de flexibilité.
...
Elles offrent également la possibilité d'utiliser [des modèles](89_les_modeles_home_assistant.md#fiche-les_modeles_dans_home_assistant).
