...
* Il est également possible d'ajouter des valeurs à votre message, par exemple la valeur d'un capteur (commande de type Info seulement). Il vous faudra entrer vous-même [la chaîne qui mène à cette valeur](42_aller_plus_loin_avec_les_scenarios.md#fiche-retrouver_la_chaine_qui_identifie_une_commande).
...
* Le niveau du log peut être, par ordre de gravité :
  ...
  Attention : selon les [configurations du niveau de log](41_les_fichiers_journaux_de_jeedom_log_files.md#fiche-configurer_les_fichiers_journaux), seuls les messages d'un certain niveau seront enregistrés.
