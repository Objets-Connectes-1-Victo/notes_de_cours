...
N'oubliez pas que vous avez à votre disposition différentes <a href="fiche-comment_deboguer_un_scenario.md#comment_deboguer_un_scenario">techniques de débogage</a> pour vos scénarios.

1. Dans votre boîte Jeedom, <a href="fiche-lancer_un_script_python_avec_le_plugin_script.md#lancer_un_script_python_avec_le_plugin_script">ajoutez une commande qui permet de lancer le script</a> qui allume la DEL bleue. Testez votre script à l'aide du bouton Tester disponible à côté de la commande.
2. Faites le nécessaire pour que lorsqu'une porte de votre système domotique s'ouvre, <a href="fiche-lancer_un_script_python_avec_le_plugin_script.md#lancer_un_script_python_avec_le_plugin_script">la DEL bleue s'allume</a>. Autrement dit, le scénario doit appeler la commande associée au script Python lorsque la condition est rencontrée.
