...

## 247 — 4.1 Configurer Home Assistant pour l'envoi de courriel
...

## 248 — 5.1 Erreur « Unable to find service notify »
...
![�?chec d'appel du service ](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-UnableToFindServiceNotify.png)
...

## 249 — 6.1 Erreur « Aucune entité correspondante trouvée »
...

## 251 — 9.1 Les zones dans Home Assistant
...
## 253 — 9.5 Automatisation qui tient compte de la présence
...
## 254 — 9.6 Simuler la position GPS d'une personne avec device\_tracker.see
...
## 258 — 2.3 Installation de SQLite
...
## 259 — 2.4 La ligne de commande SQLite
...
## 260 — 2.5 Fonctions SQLite pour manipuler des nombres
...
## 261 — 2.6 Fonctions SQLite pour manipuler du texte
...
## 263 — 2.8 Autres opérations intéressantes
