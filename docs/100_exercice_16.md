...
4. Créez un [device_tracker](99_detecteur_de_presence_sous_home_assistant.md#fiche-simuler_la_position_gps_d_une_personne_avec_device_tracker_see) qui simule votre propre position. Déplacez-vous virtuellement dans chacune des zones que vous avez configurées.
