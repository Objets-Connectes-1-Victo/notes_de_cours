...
Jeedom vous intéresse? Commencez ici : [installation_de_jeedom_et_premier_acces](17_jeedom_au_coeur_de_votre_systeme_domotique.md#fiche-installation_de_jeedom_et_premier_acces).
...
Pour vous lancer avec Home Assistant, suivez le guide : [installation_de_home_assistant_et_premier_acces](66_home_assistant_au_coeur_de_votre_systeme_domotique.md#fiche-installation_de_home_assistant_et_premier_acces).
