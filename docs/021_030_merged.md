...
## 41 — 8.2 Installation de Home Assistant et premier accès
...
* [Préparer la carte micro SD](999_999_merged.md#carte)
* [Configurations initiales (clé USB)](999_999_merged.md#usb)
* [Démarrer le Raspberry Pi](999_999_merged.md#demarrer)
* [Accéder à Home Assistant](999_999_merged.md#acceder)
* [Vérifier la présence des fichiers de configuration de la clé USB](999_999_merged.md#presence)
...
* Spécifiez sur quelle carte l'image doit être installée puis cliquez sur �?crire.
* Une fois l'image en place sur la carte micro SD, vous pourriez avoir à l'écran un message du genre « Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur. » ou, en anglais « The disk you connected cannot be read on this computer ».
* Ceci est normal, cliquez sur Ignorer.

  ![Le disque que vous avez inséré n�?Test pas lisible par cet ordinateur.](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-LeDisqueQueVousAvezInsereNEstPasLisibleParCetOrdinateur.png) ![Le disque que vous avez inséré n�?Test pas lisible par cet ordinateur.](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Mac-LeDisqueQueVousAvezAttacheNEstPasLisibleParCetOrdinateur-BigSur.png)

## Configurations initiales (clé USB)

Vous l'avez peut-être remarqué, lors de l'installation de Home Assistant, Raspberry Pi Imager ne vous a pas offert l'option MODIFIER R�?GLAGES. En effet, cette option n'est disponible que lors de l'installation de Raspberry Pi OS.
...
Il faut maintenant copier la clé publique dans un fichier à la racine du [volume CONFIG](999_999_merged.md#usb).
...
�? partir de l'invite ha >, passez au terminal HassOS :
...
Pendant que l'installation est en cours, Vous pouvez [accéder à l'interface Web de Home Assistant](999_999_merged.md#acceder) pour voir la progression (voir détails plus bas).
...
## 42 — 8.3 Le terminal HassOS et la console Home Assistant
...
* [Console Home Assistant vs Terminal HassOS](999_999_merged.md#vs)
  + [Branchement avec clavier et écran](999_999_merged.md#clavier)
  + [Branchement SSH](999_999_merged.md#ssh)
* [Console Home Assistant](999_999_merged.md#consoleha)
  + [Quelques commandes utiles](999_999_merged.md#commandesconsoleha)
  + [Passer de la console Home Assistant au terminal HassOS](999_999_merged.md#consolehavsterminal)
* [Terminal HassOS](999_999_merged.md#terminalhassos)
  + [Quelques commandes utiles](999_999_merged.md#commandesterminalhassos)
  + [Effectuer une commande Home Assistant dans terminal HassOS](999_999_merged.md#commandeha)
  + [Passer du terminal HassOS vers la console Home Assistant](999_999_merged.md#terminalvsconsoleha)
...
Les détails de la console Home Assistant [sont donnés plus bas](999_999_merged.md#consoleha).
...
Les détails du Terminal HassOS [sont donnés plus bas](999_999_merged.md#terminalhassos).
...
## 43 — 8.4 �?teindre ou redémarrer Home Assistant de façon sécuritaire
...

## 44 — 9.1 Les couches logicielles de Home Assistant
...
Dans les versions plus récentes de Home Assistant, on peut encore voir ces couches quand on se rend dans le menu Paramètres / �? propos.

![�? propos](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-APropos.png)

## Pour plus d'information

« Develppers - Architecture ». Home Assistant. <https://developers.home-assistant.io/docs/architecture_index>

## 45 — 9.2 Configurer l'accès au réseau dans Home Assistant
...
Lorsque vous branchez le Pi au réseau câblé, aucune configuration particulière n'est requise, sauf si vous désirez fournir une [adresse IP statique](999_999_merged.md#ipstatique) ou encore si les configurations de votre réseau nécessitent que vous fournissiez l'[apical\_lien\_interne][installation\_de\_home\_assistant\_et\_premier\_acces,adresse d'un serveur DNS,dns][/apical\_lien\_interne].
...
* [Fichiers de configuration sur une clé USB](999_999_merged.md#usb)
* [Fichiers de configuration directement dans le terminal HassOS](999_999_merged.md#hassos)
* [Commandes au terminal HassOS](999_999_merged.md#terminal)
* [Interface Web](999_999_merged.md#web)
...
�? son ouverture, vi vous place en mode commande. Pour passer d'un mode à l'autre :

* en mode commande : la lettre i vous place en mode insertion, ce qui permet d'éditer le texte
* en mode insertion : �?chap vous place en mode commande

Pour enregistrer le document puis fermer l'éditeur : �?chap suivi de : w q (ce qui signifie Write and Quit).

Pour fermer l'éditeur sans enregistrer : �?chap suivi de : q !.
...
Si vous aviez entré les configurations réseau [à l'aide d'une clé USB](999_999_merged.md#usb), il est également possible d'utiliser la configuration Web pour les ajuster après coup.
...
## 46 — 9.3 Adresse IP statique pour Home Assistant
...
* [�? l'aide d'un fichier de configuration placé sur une clé USB](999_999_merged.md#usb)
* [En éditant les fichiers de configuration directement dans le terminal HassOS](999_999_merged.md#hassos)
* [�? l'aide de l'interface graphique de Home Assistant](999_999_merged.md#graphique)
...

Il est possible de configurer l'adresse IP directement à partir de l'interface graphique de Home Assistant. �?videmment, l'adresse utilisée initialement aura été fournie par DHCP.
...
## 47 — 9.4 Se brancher à Home Assistant via SSH
...
* �? l'aide de ce module complémentaire, créez un nouveau fichier nommé authorized\_keys. Il sera placé [apical\_lien\_interne][dossier\_config,dans le dossier config][/apical\_lien\_interne], c'est-à-dire /mnt/data/supervisor/homeassistant.
...
## 48 — 9.5 Ajuster la date et l'heure de Home Assistant
...
* [Retrouver la date, l'heure et le fuseau horaire au terminal](999_999_merged.md#infosterminal)
* [Retrouver les informations dans l'interface graphique](999_999_merged.md#infosgraphique)
  + [Fuseau horaire](999_999_merged.md#fuseaugraphique)
  + [Date et heure](999_999_merged.md#dategraphique)
* [Si la date ou l'heure sont erronés](999_999_merged.md#errone)
* [Ajustements au terminal](999_999_merged.md#ajustementsterminal)
  + [Fuseau horaire](999_999_merged.md#fuseau)
...
## 49 — 9.6 Obtenir la version de Home Assistant installée sur mon Raspberry Pi
...
* [retrouver l'information à partir de l'interface graphique](999_999_merged.md#graphique)
* [retrouver l'information à la ligne de commande](999_999_merged.md#commande)

## Interface graphique

Dans l'interface graphique de Home Assistant, rendez-vous dans le menu Paramètres / �? propos.
...
![�?cran �? propos](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-APropos.png)
...
## 50 — 9.7 Trouver l'adresse IP de Home Assistant
...
## 51 — 9.10 Réinitialiser le mot de passe de Home Assistant (et le code d'usager si désiré)
...
## 52 — 9.11 Liste de vérification pour Home Assistant
...
* Les configurations d'accès au réseau (câblées ou sans fil) sont-elles bien réalisées? [Voir plus bas comment le vérifier.](999_999_merged.md#configurationsreseau)
...
* Les configurations d'accès au réseau sont-elles bien réalisées? [Voir plus bas comment le vérifier.](999_999_merged.md#configurationdns)
...
* Assurez-vous que le Pi a accès à internet ([voir plus haut](999_999_merged.md#internet)).
...
* Le Pi a-t-il accès à un serveur DNS? [Voir plus haut pour le vérifier.](999_999_merged.md#configurationdns)
* Tentez une réinitialisation à l'aide de la commande ha core restart.

## 53 — 9.12 Intégration Tuya pour ajouter des prises Wi-Fi Teckin dans Home Assistant
...
Vous trouverez quelques liens pour d'autres solutions [au bas de cette page](999_999_merged.md#local).
...
* [Configuration de la prise Wi-Fi sur votre téléphone](999_999_merged.md#telephone)
* [Configuration d'un compte de développpeur chez Tuya](999_999_merged.md#tuya)
* [Configuration de l'intégration Tuya dans Home Assistant](999_999_merged.md#homeassistant)
...
* �?teignez la prise pendant 10 secondes puis allumez-la.
...
## 54 — 9.13 Intégration TP-Link Kasa Smart pour ajouter une prise Kasa à Home Assistant
...
* [Connecter la prise à votre réseau Wi-Fi](999_999_merged.md#wifi)
* [Installer l'intégration TP-Link Kasa Smart](999_999_merged.md#integration)
* [Ajouter la prise à Home Assistant](999_999_merged.md#ha)
...

## 56 — 0.1 Erreur « wlan0: link is not ready »
...
## 58 — 0.3 Impossible d'obtenir l'interface Web de Home Assistant sur mon ordinateur
...
## 59 — 0.4 Erreur « dd: /dev/rdisk2: Device not configured »
...
De plus, sur mon Mac, j'obtiens sans cesse le message « Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur » (en anglais : « The disk you connected cannot be read on this computer ») pendant que la commande dd fait son travail sur la carte micro SD.

![Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Mac-SerieAvertissementsLeDisqueQueVousAvezAttacheNEstPasLisibleParCetOrdinateur.png)
...
## 60 — 0.5 Erreur « dd: /dev/rdisk2: Operation not permitted »
...
Lorsque vous avez inséré la carte micro SD dans votre ordinateur, vous avez cliqué sur �?jecter dans la boîte « Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur » ou en anglais « The disk you connected cannot be read on this computer », ce qui a rendu le disque non disponible pour cette opération.

![Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur.](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/Mac-LeDisqueQueVousAvezAttacheNEstPasLisibleParCetOrdinateur-BigSur.png)

### Solution proposée :

Retirez la carte micro SD de l'ordinateur puis insérerz-la à nouveau. Quand vous verrez la boîte de dialogue « Le disque que vous avez attaché n�?Test pas lisible par cet ordinateur », cliquez sur Ignorer.

Vous pourrez ensuite lancer les opérations pour flasher l'image sur la carte micro SD.

## 61 — 0.6 �?cran "Preparing Home Assistant" reste affiché à l'infini
...
## 62 — 0.7 Erreur « Failed to install add-on »
...
## 63 — 0.8 Erreur Z-Wave JS « Server version is incompatible »
...
## 64 — 0.9 Erreur incompréhensible dans configuration.yaml
...
## 65 — 0.10 scp ne fonctionne pas alors qu'il est possible de se brancher via ssh
...
## 66 — 0.11 Erreur « sqlite3: command not found »
...
## 67 — 0.12 Option pour vérifier les configurations non disponible
...
## 68 — 0.13 Erreur « Unknown error, see supervisor »
...
## 69 — 0.14 Erreur « Entité non disponible actuellement »
...
## 70 — 0.15 Erreur « Unknown error occured »
...
## 71 — 0.16 Erreur Z-Wave JS « Réessayer la configuration: Cannot connect to host »
...
## 72 — 0.17 Erreur Z-Wave JS « Réessayer la configuration: None »
...
![Tuya �?chec de la configuration](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-ZWaveJS-ReessayerLaConfigurationNone.png)
...
## 73 — 0.18 Erreur Z-Wave JS « Réessayer la configuration: Failed to get the Z-Wave JS add-on info »
...
## 74 — 0.19 Erreur Tuya « �?chec de la configuration »

### Problème :

Lorsque vous accédez à l'écran Configuration / Intégrations, la tuile Tuya affiche le message « Tuya �?chec de la configuration. Vérifier les journaux » ou, en anglais « Tuya Failed to set up. Check the logs ».

![Tuya �?chec de la configuration](NotesDeCoursApical-420_3a4_vi_objets_connectes_1_a_2025_files/HomeAssistant-Tuya-EchecDeLaConfiguration.png)
...
* �? côté de My Cloud Projects, cliquez sur Upgrade IoT Core Plan.
...
## 75 — 0.20 SSH : Erreur « Permission denied (publickey) »
...
* �? l'aide de ce module complémentaire, créez un nouveau fichier nommé authorized\_keys.
* Sur votre système Windows, à l'aide d'une fenêtre PowerShell, affichez la valeur de votre clé publique SSH.
...
## 76 — 0.21 Erreur « System is not ready with state: setup »
...
## 77 — 0.22 Erreur « Response error: 401 »
...
## 78 — 0.23 Module complémentaire non trouvé
...
## 79 — 0.24 Erreur « ERR\_CONNECTION\_REFUSED  »
...
## 80 — 0.25 Erreur « System is not healthy »

### Problème :

Lorsque vous tentez d'installer un module complémentaire dans Home Assistant, vous obtenez le message « �?chec de l'installation de l'extension 'AddonManager.install' blocked from execution, system is not healthy - setup ».
...
## 82 — 0.27 Erreur « �?chec de l'appel du service update/install »

### Problème :

Lorsque vous tentez d'effectuer une mise à jour de Home Assistant, vous obtenez le message « �?chec de l'appel du service update/install. Error updating Home Assistant Operating System: 'OSManager.update' blocked from execution, supervisor needs to be updated first ».
...
6. [apical\_lien\_interne][Eteindre\_home\_assistant\_de\_facon\_securitaire,�?teignez Home Assistant de façon sécuritaire][/apical\_lien\_interne].
...
## 85 — 3.3 Ajouter un appareil connecté Z-Wave à Home Assistant
...
## 86 — 4.2 Réinstaller Home Assistant à partir d'une sauvegarde
...
* Poursuivez avec [les étapes communes pour la réinstallation et la restauration](999_999_merged.md#commune).
...
## �?tapes communes pour la réinstallation et la restauration
...
* �? la fin de l'opération, vous aurez votre Home Assistant tel qu'il était au moment où vous avez effectué cette sauvegarde.
...

1. Changez le nom de votre installation Home Assistant. Ce nom doit correspondre à votre nom complet au format Prénom NomDeFamille. �? vous de fouiller dans les options de menu pour trouver comment faire.
...
10. [apical\_lien\_interne][Eteindre\_home\_assistant\_de\_facon\_securitaire,�?teignez Home Assistant de façon sécuritaire][/apical\_lien\_interne].
