...
* Travailler avec un API (Application Programming Interface) (expliqué dans la présente fiche [et dans la suivante](117_communication_home_assistant_jeedom_via_lapi.md#fiche-jeedom_recuperer_la_valeur_d_un_capteur_branche_sur_home_assistant_ou_la___))
* [MQTT](121_mqtt.md#fiche-publication_et_abonnement_mqtt_avec_home_assistant)
...
Sous Jeedom, [un URL est assigné à chaque commande ou état d'un objet connecté](117_communication_home_assistant_jeedom_via_lapi.md#fiche-url_d_un_objet_connecte_jeedom). C'est grâce à cet URL, que Home Assistant pourra récupérer la valeur d'un capteur branché sur une boîte domotique Jeedom ou encore de modifier la valeur d'un récepteur.
...
La technique est tout à fait opposée à celle utilisée pour [récupérer dans Home Assistant une valeur en provenance de Jeedom](117_communication_home_assistant_jeedom_via_lapi.md#fiche-home_assistant_interagir_avec_un_objet_branche_sur_jeedom).
...
* Dans Jeedom, [créez un équipement virtuel](34_les_equipements_virtuels_dans_jeedom.md#fiche-travailler_avec_le_plugin_virtuel) qui recevra la valeur de Home Assistant.
...
* Dans [l'interface Web de Jeedom,acceder](17_jeedom_au_coeur_de_votre_systeme_domotique.md#fiche-installation_de_jeedom_et_premier_acces), rendez-vous dans le menu Plugins / Protocole domotique / Z-Wave (ou autre menu qui donne accès à l'équipement recherché s'il ne s'agit pas d'un objet connecté Z-Wave).
...
Dans les configurations de cet équipement, [on créera une commande,actions](34_les_equipements_virtuels_dans_jeedom.md#fiche-travailler_avec_le_plugin_virtuel) de type info. C'est dans cette info que la valeur sera stockée.
